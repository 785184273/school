...
function changef1(){
	doc.getId('obj_w').setAttribute("class,active");
	doc.getId('doc_w').setAttribute("class,' '")
...
function changef2(){
	doc.getId('obj_w').setAttribute("class,' '");
	doc.getId('doc_w').setAttribute("class,active")
