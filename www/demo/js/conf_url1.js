...
function delinfo(dt){
	if(confirm('你真的要删除吗?')){
		var val = "date=" + dt;
		ajaxop('post','./conf_url_del.php',val);
	}
}
//获得数据条数
function numinfo(){
